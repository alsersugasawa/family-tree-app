...
This directory contains deployment and utility scripts for the Family Tree App.
...
5. Deploys the Family Tree application
...
- `NAMESPACE` - Kubernetes namespace (default: family-tree)
